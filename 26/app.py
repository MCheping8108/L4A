...
microblogs = [
    {'id': '1', 'username': '小辛辛', 'head': 'head01.jpg', 'photo': 'blog01.png', 'create_time': '2018/12/26case'},
    {'id': '2', 'username': 'YUTAR', 'head': 'head02.jpg', 'photo': 'blog02.png', 'create_time': '2018/12/26case'},
    {'id': '3', 'username': '赤道', 'head': 'head03.jpg', 'photo': 'blog03.png', 'create_time': '2018/12/26case'},
    {'id': '4', 'username': 'Wang Ming', 'head': 'head04.jpg', 'photo': 'blog04.png', 'create_time': '2018/12/26case'},
...
@app.route('/')
def index():
    # 获取session，如果session不存在，则重定向到登录页
...
def microblog_load():
    # 从 cookie 中获取当前页数
    page = request.cookies.get('page')
    # 如果page是None，默认加载第2页，否则加载当前页的下一页
    if page is None:
        page = 2
    else:
        page = int(page) + 1
